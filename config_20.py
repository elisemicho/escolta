...
config = {
            ...
            "train_file":"mgb3_mfcc_fft400_hop160_vad_cmvn_train.0.tfrecords",
            "dev_file":"mgb3_mfcc_fft400_hop160_vad_cmvn_dev.0.tfrecords",
            "test_file":"mgb3_mfcc_fft400_hop160_vad_cmvn_test.0.tfrecords",
            # "train_file":"train_completesample.tfrecords",
            # "dev_file":"dev_completesample.tfrecords",
            # "test_file":"dev_completesample.tfrecords",
            # # architecture
            "model_architecture": "organizers",  #What model architecture to use among "simple_conv1D", "simple_conv2D", "lstm" or "cnn_lstm"
            #optimizer
            "optimizer": "GradientDescent", # options = {"Adadelta", "Adam", "GradientDescent", "Adagrad"}
            "learning_rate": 0.001,
            "ADAM_epsilon": 1e-8,
            "num_epochs": 15,  #Number of epochs to run trainer
            "batch_size": 4,
